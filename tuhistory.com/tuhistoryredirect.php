<?php
  ...
  $oldSiteGlobal = 'tuhistory.com';

  $newUrl = array(
    'www.historyplay.tv/{pais}/',
    'latam.historyplay.tv/biografias/',
    'latam.historyplay.tv/biografias/{variable}',
    'latam.historyplay.tv/contacto',
    'www.historyplay.tv/{pais}/programas/',
    'latam.historyplay.tv/content/{variable}',
    'latam.historyplay.tv/donde-vernos',
    'www.historyplay.tv/{pais}/programas/',
    'www.historyplay.tv/{pais}/programas/',
    'www.historyplay.tv/{pais}/',
    'latam.historyplay.tv/expandido/{variable}',
    'www.historyplay.tv/{pais}/',
    'latam.historyplay.tv/galeria/{variable}',
    'www.historyplay.tv/{pais}/',
    'www.historyplay.tv/{pais}/history2',
    'www.historyplay.tv/{pais}/history2',
    'www.historyplay.tv/{pais}/horarios',
    'www.historyplay.tv/{pais}/horarios',
    'www.historyplay.tv/{pais}/history2',
    'latam.historyplay.tv/hoy-en-la-historia/',
    'latam.historyplay.tv/hoy-en-la-historia/{variable}',
    'www.historyplay.tv',
    'latam.historyplay.tv/microsites/{variable}',
    'www.historyplay.tv/{pais}/programas/',
    'www.historyplay.tv/{pais}/programas/',
    'www.historyplay.tv',
    'www.historyplay.tv',
    ...
    'www.historyplay.tv',
    'latam.historyplay.tv/rrpp-prensa',
    'latam.historyplay.tv/terminos-uso',
    'www.historyplay.tv',
    'www.historyplay.tv',
    'www.historyplay.tv',
    'unaidea.historyplay.tv/',
    'unaidea.historyplay.tv/',
    'www.historyplay.tv',
    'www.historyplay.tv',
    'latam.historyplay.tv/quienes-somos',
    ...
    'www.historyplay.tv/{pais}/horarios',
    'www.historyplay.tv/{pais}/programas',
    'unaidea.historyplay.tv/{variable}',
    'www.historyplay.tv',
    'www.historyplay.tv',
    'latam.historyplay.tv/que-demonio-legendario-eres',
    'latam.historyplay.tv/que-personaje-historico-eres',
    'latam.historyplay.tv/--que-guerrero-letal-de-la-historia-eres-',
    'www.historyplay.tv/{pais}/serie/lo-mejor-del-precio-de-la-historia_60g6zb',
    'www.historyplay.tv/{pais}/serie/lo-mejor-de-cazadores-de-tesoros_appt4c',
    'www.historyplay.tv/{pais}/serie/el-precio-de-la-historia_c5fzqv',
    'www.historyplay.tv/{pais}/serie/locos-por-los-autos_jnnx0r',
    'www.historyplay.tv/{pais}/serie/rutas-mortales_wzyy3d',
    'www.historyplay.tv/{pais}/serie/quien-da-ma_2ckwu7',
    'unaidea.historyplay.tv/'
  );

  $oldUrl = array(
    '{pais}.'.$oldSiteGlobal.'',
    '{pais}.'.$oldSiteGlobal.'/biografias/',
    '{pais}.'.$oldSiteGlobal.'/biografias/{variable}',
    '{pais}.'.$oldSiteGlobal.'/contacto',
    '{pais}.'.$oldSiteGlobal.'/content/',
    '{pais}.'.$oldSiteGlobal.'/content/{variable}',
    '{pais}.'.$oldSiteGlobal.'/donde-vernos',
    '{pais}.'.$oldSiteGlobal.'/etiquetas/',
    '{pais}.'.$oldSiteGlobal.'/etiquetas/{variable}',
    '{pais}.'.$oldSiteGlobal.'/expandido/',
    '{pais}.'.$oldSiteGlobal.'/expandido/{variable}',
    '{pais}.'.$oldSiteGlobal.'/galeria/',
    '{pais}.'.$oldSiteGlobal.'/galeria/{variable}',
    '{pais}.'.$oldSiteGlobal.'/google_vignette',
    '{pais}.'.$oldSiteGlobal.'/h2',
    '{pais}.'.$oldSiteGlobal.'/history2',
    '{pais}.'.$oldSiteGlobal.'/horarios',
    '{pais}.'.$oldSiteGlobal.'/horarios-programas',
    '{pais}.'.$oldSiteGlobal.'/horarios-programas-history2',
    '{pais}.'.$oldSiteGlobal.'/hoy-en-la-historia',
    '{pais}.'.$oldSiteGlobal.'/hoy-en-la-historia/{variable}',
    '{pais}.'.$oldSiteGlobal.'/microsites/',
    ...
    '{pais}.'.$oldSiteGlobal.'/node/',
    '{pais}.'.$oldSiteGlobal.'/node/109631',
    ...
    '{pais}.'.$oldSiteGlobal.'/programa/',
    '{pais}.'.$oldSiteGlobal.'/programa/{variable}',
    '{pais}.'.$oldSiteGlobal.'/programas',
    '{pais}.'.$oldSiteGlobal.'/programas/{variable}',
    '{pais}.'.$oldSiteGlobal.'/publicidad',
    '{pais}.'.$oldSiteGlobal.'/quienes_somos',
    '{pais}.'.$oldSiteGlobal.'/region/{variable}',
    ...
    '{pais}.'.$oldSiteGlobal.'/zonas/',
    '{pais}.'.$oldSiteGlobal.'/zonas/{variable}',
    ...
    ''.$oldSiteGlobal.'',
    'www.'.$oldSiteGlobal.'',
    '{pais}.'.$oldSiteGlobal.'/que-demonio-legendario-eres',
    '{pais}.'.$oldSiteGlobal.'/que-personaje-historico-eres',
    '{pais}.'.$oldSiteGlobal.'/--que-guerrero-letal-de-la-historia-eres-',
    '{pais}.'.$oldSiteGlobal.'/programas/lo-mejor-del-precio-de-la-historia',
    '{pais}.'.$oldSiteGlobal.'/programas/lo-mejor-de-cazadores-de-tesoros',
